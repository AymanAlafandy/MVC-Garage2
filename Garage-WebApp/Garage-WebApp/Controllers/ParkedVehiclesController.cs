...
namespace Garage_WebApp.Controllers
{
    public class ParkedVehiclesController : Controller
    {
        ...
        public ActionResult VehicleList()
        {
            ...
            foreach(var n in db.Vehicle)
            {
                model.Add(new VehicleList(n));
            }
            return View(model);
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Type,RegNr,Color,Brand,Model,NumberOfWheels,ParkingTime,CheckInTime,CheckOutTime")] ParkedVehicle parkedVehicle)
        {
